...
export function Footer() {
  ...
  return (
    <footer className="w-full border-t border-border bg-gradient-to-r from-cyan-50/80 via-white to-sky-50/80 pt-16 pb-8 text-sm">
      <Container>
        <div className="grid grid-cols-1 gap-12 lg:grid-cols-5 xl:gap-16">
          ...
          <div className="flex flex-col gap-6 lg:col-span-2">
            ...
            <div className="flex flex-col gap-3 mt-2">
              <span className="font-semibold text-slate-900">Get the Liora App</span>
              <div className="flex flex-wrap gap-3">
                {/* Placeholder App Store Buttons */}
                <Link href="https://www.apple.com/app-store/" target="_blank" rel="noopener noreferrer">
                  <Button variant="outline" className="h-12 w-36 gap-2 justify-start px-3 bg-slate-900 text-white hover:bg-slate-800 hover:text-white border-transparent cursor-pointer">
          ...
          <div className="grid grid-cols-2 gap-8 sm:grid-cols-3 lg:col-span-3">
            ...
            <div className="flex flex-col gap-4 col-span-2 sm:col-span-1">
              ...
              <ul className="flex flex-col gap-3">
                <li>
                  <a href="mailto:support@liora.com" className="flex items-center gap-2 text-slate-600 hover:text-primary transition-colors">
        ...
        <div className="mt-16 flex flex-col items-center justify-between gap-6 border-t border-border pt-8 sm:flex-row">
          ...
          <div className="flex items-center gap-4 text-slate-400">
            <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors cursor-pointer" aria-label="Facebook">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c4.56-.93 8-4.96 8-9.75z" />
              </svg>
            </a>
            <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors cursor-pointer" aria-label="Twitter">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
              </svg>
            </a>
            <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors cursor-pointer" aria-label="Instagram">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
            ...
            <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors cursor-pointer" aria-label="LinkedIn">
              <svg className="h-5 w-5 fill-current" viewBox="0 0 24 24">
